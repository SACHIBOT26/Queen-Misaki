...
try {
    ...
    console.log("🌍 Connected to the Queen Misaki")
} catch {
...
setTimeout(() => {
    ...
    async function syncdb() {
        ...
        const Void = VoidConnect({
            ...
            browser: ['QueenMisaki', 'safari', '1.0.0'],
...
app.listen(port, () => console.log(`Queen-Misaki Server listening on port http://localhost:${port}!`));
